        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PadrinhoId = table.Column<string>(nullable: true),
                    PadrinhoId1 = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Animais_PerfilTable_PadrinhoId1",
                        column: x => x.PadrinhoId1,
                        principalTable: "PerfilTable",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
